//
//  EditarTemasTableViewController.m
//  PrimeComoFazer
//
...
@interface EditarTemasTableViewController ()
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath;
@end

@implementation EditarTemasTableViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationController.title = @"Edição de temas";
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    EditarTemaTableViewController *newController = [self.storyboard instantiateViewControllerWithIdentifier:@"EditarTema"];
...
- (void)insertNewObject
{
    ...
    [newManagedObject setValue:@"<título do tema>" forKey:@"titulo"];
